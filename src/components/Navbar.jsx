                ...
                <div className="max-w-7xl w-full flex justify-between items-center px-4">
                    ...
                    <nav className="md:flex hidden gap-8 items-center">
                        <div className="flex gap-8 text-[15x]">
                            ...
                            <a href="#about" className='transition duration-300 hover:text-orange-500' onClick={handleCloseMobileMenu}>Skills</a>
                            <a href="#skills" className='transition duration-300 hover:text-orange-500' onClick={handleCloseMobileMenu}>Projects</a>
                            <a href="#projects" className='transition duration-300 hover:text-orange-500' onClick={handleCloseMobileMenu}>Contact</a>
                        </div>
                    </nav>
            ...
            <div className={`fixed inset-0 bg-white z-50 flex flex-col justify-center items-center transition-all duration-300 ${showMobileMenu ? 'translate-x-0' : 'translate-x-full'} md:hidden`}>
                ...
                <nav className='flex flex-col w-full justify-between gap-8'>
                    <div className="flex flex-col items-center text-center gap-8 text-[20px]">
                        ...
                        <a href="#project" className='transition duration-300 hover:text-orange-500' onClick={handleCloseMobileMenu}>Project</a>
                    </div>

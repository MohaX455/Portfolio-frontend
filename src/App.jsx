...
const App = () => {
  ...
  return (
    <div className="font-[poppins] text-gray-700 relative tracking-wide transition duration-300 scroll-smooth">
      ...
      `}>
        <div className="bg-[#222] w-[70%] md:w-fit h-[90px] px-6 flex justify-center items-center 
                        border-2 border-[rgba(255_255_255_/_0.3)] rounded-md shadow-2xl">
          <p className="text-white font-medium text-[15px] md:text-[17px]">
